 ...
 * Uses Android Developer Sample Code.
 *
 * Important to the Security project:
 * onCreate(savedInstanceState: Bundle?)
 * fetchAddressButtonHandler(view: View)
 * createLocationRequest()
 * getPendingIntent()
 * requestLocationUpdates(view: View?)
 * requestPermissions()
 * and the LocationUpdatesBroadcastReceiver.kt file
 * (everything else is from the template, mainly just kept intact for the UI)
 *
 */
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getPendingIntent(): PendingIntent? {
        ...
        LocationUpdatesBroadcastReceiver.wrfile = File(file, "sample.csv")
